...
public class KeyGenerator
{
    ...
    private string ConnectionString;// đang cố định là NV021
    public KeyGenerator()
    {
        ConnectionString = "Data Source=(DESCRIPTION =(ADDRESS = (PROTOCOL = TCP)(HOST = localhost)(PORT = 1521))(CONNECT_DATA = (SERVER = DEDICATED)(SERVICE_NAME = xe)));Password=NV021123#;User ID=NV021";
    }
...
class Program
{
    static void Main(string[] args)
    {
        ...
        //foreach (string employeeId in employeeIds)
        //{
        //    //keyGenerator.GenerateAndSaveKeys(employeeId);
        //    //Console.WriteLine("Keys generated and saved for employee: " + employeeId);

        //    // Lấy khóa công khai từ Oracle
        //    string publicKey = keyGenerator.LoadPublicKeyFromOracle(employeeId);
        //    Console.WriteLine("employee: " + employeeId);

        //    // Mã hóa giá trị lương và phụ cấp
        //    string encryptedLuong = keyGenerator.RSAEncrypt("123456.78", publicKey);
        //    string encryptedPhuCap = keyGenerator.RSAEncrypt("5000.00", publicKey);

        //    // Lưu giá trị đã mã hóa vào bảng NHANVIEN
        //    keyGenerator.SaveEncryptedValuesToOracle(employeeId, encryptedLuong, encryptedPhuCap);
        ...
        //}
        //keyGenerator.DecryptSalaryAndAllowanceForAllEmployees();

        keyGenerator.EncryptAndSaveSalaryAndAllowance(keyGenerator);
